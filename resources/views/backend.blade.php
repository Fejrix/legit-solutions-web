...
<main class="flex flex-auto mt-[70px] mb-[30px] md:mt-[120px] md:mb-[120px] subpixel-antialiased h-[492px] items-center px-12 xl:px-[215px]">
    <section class="text-center md:text-left xl:pr-20 md:pr-5">
        <h1 class="text-3xl text-orange-400">Web Design - Backend</h1>
        <p class="text-2xl text-white nadpis-legit">Jakub Trčka</p>

        <p class="text-legit"></p>
        ...
        >
          ...
          <blockquote class="relative p-4 mb-4">
            ...
            <p class="text-sm text-neutral-700">
                Jsem "PROČ" skupiny Legit Solutions. Společně s Davidovým "JAK" tvoříme skvělý tým, který tě nenechá ve štychu.
            </p>
          </blockquote>
        </div>
    </section>
